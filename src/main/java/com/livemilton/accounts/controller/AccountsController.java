...
@Tag(
        name="CRUD REST APIs for Accounts in livemiltonBank",
        description = "CRUD REST APIs in livemiltonBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer & Account inside livemiltonBank"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            ...
            description = "Get Java versions details that is intalled into accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
